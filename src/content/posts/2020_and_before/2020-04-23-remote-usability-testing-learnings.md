---
slug: remote-usability-testing-learnings
title: Remote Usability Testing Learnings
description: >-
  Here’s how we did our fully remote Usability Testing sessions during COVID-19
...
publicationNotes: >-
  ...
  href="https://medium.com/somiacx/remote-usability-testing-learnings-2def217d91b9">Somia
  CX Thought</a>.
canonicalUrl: 'https://medium.com/somiacx/remote-usability-testing-learnings-2def217d91b9'
---
...
<figcaption class="figcaption">We’ve decided early on that we wanted to see the participants while they’re using the prototype.</figcaption>
</figure>

The laptop is used to cast the video of the participant while they’re using the
...
[our quick tips on remote research that you can read here](/article/2020/04/23/tips-for-running-a-remote-research.html)),
...
I know it’s called planning, but the way I see it, it’s about designing the
...
- for the consent and non-disclosure agreement form, we make it so that it’s
  ...
  ([read here on how we did it](/writings/2020/04/23/making-a-remote-consent-and-nda-form.html)).
...
<figcaption class="figcaption">Our pilot test is to check all the setup and identify other preps that might be missed.</figcaption>
</figure>
...
<figcaption class="figcaption">This is my overall setup when running the Usability Testing where I can see and monitor everything I need. Note that I used a 27" screen so you might want to adjust when using a smaller one such as a laptop screen.</figcaption>
</figure>
